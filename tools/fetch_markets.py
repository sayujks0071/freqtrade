...
def fetch_markets(exchange_id, output_file, env='india_prod'):
    ...
    if env == 'india_prod':
        ...
        urls['api'] = {'public': 'https://api.delta.exchange', 'private': 'https://api.delta.exchange'}
    elif env == 'india_testnet':
        urls['api'] = {'public': 'https://cdn-ind.testnet.deltaex.org', 'private': 'https://cdn-ind.testnet.deltaex.org'}
