...
def main():
    ...
    parser.add_argument("--db-url", type=str, default="sqlite:///user_data/tradesv3.sqlite", help="Database URL")
    ...
    avg_profit_pct = (sum(t.close_profit for t in trades) / total_trades) if total_trades > 0 else 0.0
