...
class StrategyScout:
    ...
    def _find_strategy_files(self, full_name):
        ...
        for path in paths_to_check:
            try:
                ...
                # Log that we failed to find strategy files for this path, but continue
                print(f"DEBUG: Failed to check path {path} in {full_name}")
    ...
    def _analyze_strategy_content(self, strat_file, repo):
        ...
        try:
            ...
            print(f"Failed to read file {strat_file.get('name')}: {e}")
