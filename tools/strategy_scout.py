...
def main():
    ...
    for repo in KNOWN_SOURCES:
        strategies.append({"full_name": repo, "html_url": f"https://github.com/{repo}", "description": "Known Source", "stargazers_count": "N/A"})
    ...
    with open(report_file, 'w') as f:
        ...
        for s in unique.values():
            ...
            desc = desc.replace('\n', ' ')
            f.write(f"| [{s['full_name']}]({s['html_url']}) | {s.get('stargazers_count', 0)} | {desc} |\n")
