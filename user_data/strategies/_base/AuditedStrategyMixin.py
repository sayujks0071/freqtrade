...
class AuditedStrategyMixin:
    ...
    def log_signal(self, pair: str, timeframe: str, signal_type: str, reason: str, snapshot: dict = None):
        """
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float, rate: float,
        ...
        self.log_signal(pair, self.timeframe, f"ENTRY_{side.upper()}", entry_tag or "unknown")
        return True
