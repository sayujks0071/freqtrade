...
# This is crucial so that the second config file used in docker-compose doesn't fail
...
# Ensure permissions (optional, but good for docker)
chmod -R 777 user_data/logs user_data/reports user_data/db 2>/dev/null || true
