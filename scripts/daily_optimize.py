...
def run_hyperopt_flow(worst_strategy):
    """
    Runs hyperopt for the given strategy and returns the new parameters.
    """
    ...
    if new_params:
        ...
        return strategy_json, backup_json, created_new, new_params
    else:
...
Examples:
  ...
  %(prog)s --yes
    ...
    # Run Hyperopt and get new params
