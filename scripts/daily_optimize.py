...
def establish_baseline():
    """Establish a performance baseline by running a backtest."""
...
def evaluate_results(
    ...
    """Evaluate if the new parameters improved performance."""
...
def setup_feature_branch(target_branch, backup_json, strategy_json, created_new):
    """Setup feature branch and switch to it."""
...
def git_push_workflow(
    ...
    setup_feature_branch(target_branch, backup_json, strategy_json, created_new)
...
Examples:
  ...
  %(prog)s --yes
    ...
    avg_profit_pct = evaluate_results(
        worst_strategy, current_sharpe, current_drawdown, strategy_json, backup_json, created_new
    )
