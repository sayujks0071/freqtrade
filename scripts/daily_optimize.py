...
def execute_hyperopt(worst_strategy):
    ...
    return result_hyperopt.stdout, strategy_json, backup_json, created_new
...
def commit_and_push(args, worst_strategy, avg_profit_pct, strategy_json):
...
def main():
    ...
    hyperopt_output, strategy_json, backup_json, created_new = execute_hyperopt(worst_strategy)
    ...
    if success:
        ...
        commit_and_push(args, worst_strategy, avg_profit_pct, strategy_json)
