...
def push_changes(args, worst_strategy, avg_profit_pct, strategy_json):
    ...
    if not args.yes:
        ...
        if response not in ["y", "yes"]:
            ...
            return True  # Changes committed but not pushed is still a success for the script
...
def main():  # noqa: C901
    ...
    if sharpe_improved and drawdown_improved:
        ...
        success = push_changes(args, worst_strategy, avg_profit_pct, strategy_json)
        if not success:
