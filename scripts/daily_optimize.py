...
def git_push_workflow(args, strategy_json, backup_json, worst_strategy, msg):
    if args.dry_run:
...
Examples:
  ...
  %(prog)s --yes
    ...
    if passed:
        # 4. Git Push Workflow
        git_push_workflow(args, strategy_json, backup_json, worst_strategy, msg)
