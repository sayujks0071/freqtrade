...
def establish_baseline():
    """Finds the worst performing strategy to optimize."""
...
def handle_commit_and_push(args, strategy_name, avg_profit_pct, strategy_file):
    """Handles the git commit and push operations."""
