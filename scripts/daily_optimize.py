...
def ensure_feature_branch(target_branch, backup_json, strategy_json, created_new):
...
def commit_and_push(args, worst_strategy, avg_profit_pct, strategy_json, backup_json, created_new):
    ...
    ensure_feature_branch(target_branch, backup_json, strategy_json, created_new)
...
def main():
    ...
    new_backtest_data = run_verification(worst_strategy, strategy_json, backup_json, created_new)
