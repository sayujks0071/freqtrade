...
def execute_hyperopt(worst_strategy, strategy_json, backup_json):
    created_new = False
...
def perform_git_operations(target_branch, backup_json, strategy_json, created_new):
...
def commit_and_push(args, strategy_json, worst_strategy, avg_profit_pct, backup_json, created_new):
    ...
    if args.dry_run:
        ...
        perform_git_operations(target_branch, backup_json, strategy_json, created_new)
...
Examples:
  ...
  %(prog)s --yes
    ...
    created_new = execute_hyperopt(worst_strategy, strategy_json, backup_json)
    ...
    if sharpe_improved and drawdown_improved:
        ...
        commit_and_push(
            args, strategy_json, worst_strategy, avg_profit_pct, backup_json, created_new
        )
    else:
